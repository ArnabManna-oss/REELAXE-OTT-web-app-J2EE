package org.modell.been;

public class userbeen {
	private String uid, uname, uemail, uage, uphn, ugender, subStrt, subEnd, SubAmt, upass;
	...
	public String getSubStrt() {
		return subStrt;
	}

	public void setSubStrt(String subStrt) {
		this.subStrt = subStrt;
	}
